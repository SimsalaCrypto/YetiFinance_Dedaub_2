...
contract SortedTroves is Ownable, CheckContract, ISortedTroves {
  ...
  event NodeAdded(address _id, uint256 _ICR);
  ...
  struct Node {
    ...
    uint256 oldICR; // ICR of the node last time it was updated. List is always in order
    // in terms of oldICR .
  }
   ...
   */
  function _descendList(uint256 _ICR, address _startId)
    internal
    view
   ...
   */
  function _ascendList(uint256 _ICR, address _startId)
    internal
    view
    returns (address, address)
  {
