...
contract('Gas cost tests', async accounts => {
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraw 900 PUSD
    ...
    //1 accts open Trove with 1 ether and withdraw 100 PUSD
    ...
    // Account 500 opens with 1 ether and withdraws 100 PUSD
    ...
    // Check initial troves with starting 10E/90PUSD are still open
    for (account of accounts.slice(101, 111)) { assert.isTrue(await sortedTroves.contains(account)) }
  ...
  it("", async () => {
    ...
    //2 accts open Trove with 1 ether and withdraw 100 PUSD
  ...
  it("", async () => {
    ...
    //3 accts open Trove with 1 ether and withdraw 100 PUSD
  ...
  it("", async () => {
    ...
    //5 accts open Trove with 1 ether and withdraw 100 PUSD
  ...
  it("", async () => {
    ...
    //10 accts open Trove with 1 ether and withdraw 100 PUSD
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraw 90 PUSD
    await th.openTrove_allAccounts(accounts.slice(101, 111), contracts, dec(10, 'ether'), dec(900, 18))
    for (account of accounts.slice(101, 111)) { assert.isTrue(await sortedTroves.contains(account)) }

    //20 accts open Trove with 1 ether and withdraw 100 PUSD
  ...
  it("", async () => {
    ...
    //30 accts open Trove with 1 ether and withdraw 100 PUSD
  ...
  it("", async () => {
    ...
    //40 accts open Trove with 1 ether and withdraw 100 PUSD
  ...
  it("", async () => {
    ...
    //45 accts open Trove with 1 ether and withdraw 100 PUSD
  ...
  it("", async () => {
    ...
    // Whale opens trove and fills SP with 1 billion PUSD
    ...
    // Check SP has 9e28 PUSD
    const PUSDinSP = (await stabilityPool.getTotalPUSDDeposits()).toString()
    assert.equal(PUSDinSP, dec(9, 28))

    //1 acct opens Trove with 1 ether and withdraw 100 PUSD
    const _1_Defaulter = accounts.slice(1, 2)
    await th.openTrove_allAccounts(_1_Defaulter, contracts, dec(1, 'ether'), dec(60, 18))
    ...
    // Check initial troves with starting 10E/90PUSD, and whale's trove, are still open
    for (account of accounts.slice(101, 111)) { assert.isTrue(await sortedTroves.contains(account)) }
    assert.isTrue(await sortedTroves.contains(whale))

    //Check PUSD in SP has decreased but is still > 0
    const PUSDinSP_After = await stabilityPool.getTotalPUSDDeposits()
    assert.isTrue(PUSDinSP_After.lt(web3.utils.toBN(dec(9, 28))))
    assert.isTrue(PUSDinSP_After.gt(web3.utils.toBN('0')))
  ...
  it("", async () => {
    ...
    //2 acct opens Trove with 1 ether and withdraw 100 PUSD
    const _2_Defaulters = accounts.slice(1, 3)
    await th.openTrove_allAccounts(_2_Defaulters, contracts, dec(1, 'ether'), dec(60, 18))
  ...
  it("", async () => {
    ...
    // Account 500 opens with 1 ether and withdraws 110 PUSD
  ...
  it("", async () => {
    ...
    // Account 500 opens with 1 ether and withdraws 180 PUSD
